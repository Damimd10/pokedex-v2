 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.pokedex.staging
 */

const BUNDLE_ID = 'com.pokedex'; // ios bundle id
const PACKAGE = 'com.pokedex'; // android package name
const NAME = 'pokedex'; // app name
